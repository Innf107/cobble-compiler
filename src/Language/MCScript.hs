...
compileFully :: Text -> Bool -> [S.Module 'Untyped] -> Either CompilationError [CompiledModule]
...
compileToFunctionsAtPath :: FilePath -> Text -> Bool -> [S.Module 'Untyped] -> Either CompilationError (IO ())
